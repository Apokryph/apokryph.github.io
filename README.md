...
To start the development server run `nx serve shell`. Open your browser and navigate to http://localhost:4200/. Happy
coding!
...
We are using firebase to store simple, anonymous data for highscores:
https://github.com/angular/angularfire/tree/master
